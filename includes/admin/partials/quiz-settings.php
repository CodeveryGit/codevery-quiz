        ...
        <div id="questions" class="tab-content" style="display: block">
                                        ...
                                        <div class="item-body-content">
                                            <div class="question">
                                                ...
                                                <div class="new-question">
                                                    <?php $url = add_query_arg( array( 'action' => 'cquiz_modal_window' ), admin_url( 'admin.php' ) );
                            ...
                            foreach ( $quiz_questions as $index => $quiz_question ) :
                                ...
                                <div class="item" data-index="<?php echo $index; ?>">
                                    <div class="item-wrap">
                                        <div class="item-head">
                                            <svg class="drag-item" width="20" height="20" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" id="IconChangeColor"> <path fill-rule="evenodd" clip-rule="evenodd" d="M5.5 4.625C6.12132 4.625 6.625 4.12132 6.625 3.5C6.625 2.87868 6.12132 2.375 5.5 2.375C4.87868 2.375 4.375 2.87868 4.375 3.5C4.375 4.12132 4.87868 4.625 5.5 4.625ZM9.5 4.625C10.1213 4.625 10.625 4.12132 10.625 3.5C10.625 2.87868 10.1213 2.375 9.5 2.375C8.87868 2.375 8.375 2.87868 8.375 3.5C8.375 4.12132 8.87868 4.625 9.5 4.625ZM10.625 7.5C10.625 8.12132 10.1213 8.625 9.5 8.625C8.87868 8.625 8.375 8.12132 8.375 7.5C8.375 6.87868 8.87868 6.375 9.5 6.375C10.1213 6.375 10.625 6.87868 10.625 7.5ZM5.5 8.625C6.12132 8.625 6.625 8.12132 6.625 7.5C6.625 6.87868 6.12132 6.375 5.5 6.375C4.87868 6.375 4.375 6.87868 4.375 7.5C4.375 8.12132 4.87868 8.625 5.5 8.625ZM10.625 11.5C10.625 12.1213 10.1213 12.625 9.5 12.625C8.87868 12.625 8.375 12.1213 8.375 11.5C8.375 10.8787 8.87868 10.375 9.5 10.375C10.1213 10.375 10.625 10.8787 10.625 11.5ZM5.5 12.625C6.12132 12.625 6.625 12.1213 6.625 11.5C6.625 10.8787 6.12132 10.375 5.5 10.375C4.87868 10.375 4.375 10.8787 4.375 11.5C4.375 12.1213 4.87868 12.625 5.5 12.625Z" fill="#737373" id="mainIconPathAttribute"></path> </svg>
                                            <div class="item-order-number"><?php echo $index + 1; ?></div>
                                            <div class="item-title"><?php echo $question_title; ?></div>
                                            <span class="dashicons dashicons-arrow-down-alt2 edit-item"></span>
                                        </div>
                                        <div class="item-body">
                                            <div class="item-body-wrap">
                                                <div class="item-body-content">
                                                    <div class="question">
                                                        <div class="existing-question">
                                                            <label class="control-label"><?php esc_html_e( 'Question', 'codevery-quiz' ); ?></br>
                                                                <select class="quiz-question" data-name="question" name="question[<?php echo $index; ?>][question]" id="question_<?php echo $index; ?>_question" style="width:100%;">
                                                                    <option value=""><?php esc_html_e( 'Choose Question', 'codevery-quiz' ); ?></option>
                                                                    <?php foreach ( $questions as $question ) : ?>
                                                    ...
                                                    <div class="points">
                                                        <label class="control-label"><?php esc_html_e( 'Points', 'codevery-quiz' ); ?></label>
                                                        <input type="number" class="form-control" min="0" data-name="points" name="question[<?php echo $index; ?>][points]" id="question_<?php echo $index; ?>_points" value="<?php echo $quiz_question['points'] ? $quiz_question['points'] : 0; ?>">
                                                    </div>
                                                    <!-- Repeater Remove Btn -->
                                                    <div class="remove-item-btn">
                                                        <a href="#" type="button" class="btn-danger remove-item" >
            ...
            <?php
                ...
                /* translators: %s: URL to WordPress Updates screen. */
                    ...
                    admin_url( 'post-new.php?post_type=quiz_question' )
                );
            endif;
            ?>
        </div><!-- #questions -->
        ...
        <div id="settings" class="tab-content">
            <div class="cquiz-settings-table">
                ...
                <div class="cquiz-settings-row">
                    ...
                    <input type="number" id="winner_points" name="winner_points" class="cquiz-input" min="0" value="<?php echo isset($quiz_settings['winner_points']) ? $quiz_settings['winner_points'] : ''; ?>">
                </div>

                <div class="cquiz-settings-row">
                    <label for="start_button_text" class="post-attributes-label"><?php esc_html_e( 'Start button text', 'codevery-quiz' ); ?></label>
                    <input type="text" id="start_button_text" name="start_button_text" class="cquiz-input" value="<?php echo isset($quiz_settings['start_button_text']) ? $quiz_settings['start_button_text'] : esc_html__( 'Start', 'codevery-quiz' ); ?>">
                </div>

                <div class="cquiz-settings-row">
                    <label for="title_quiz_winner" class="post-attributes-label"><?php esc_html_e( 'Success title', 'codevery-quiz' ); ?></label>
                    <input type="text" id="title_quiz_winner" name="title_quiz_winner" class="cquiz-input" value="<?php echo isset($quiz_settings['title_quiz_winner']) ? $quiz_settings['title_quiz_winner'] : ''; ?>">
                </div>

                <div class="cquiz-settings-row">
                    <label for="text_quiz_winner" class="post-attributes-label"><?php esc_html_e( 'Success description', 'codevery-quiz' ); ?></label>
                    <?php
                    $text_quiz_winner =  isset( $quiz_settings['text_quiz_winner'] ) ? $quiz_settings['text_quiz_winner'] : '';
                ...
                <div class="cquiz-settings-row">
                    ...
                    <input type="text" id="title_quiz_looser" name="title_quiz_looser" class="cquiz-input" value="<?php echo isset( $quiz_settings['title_quiz_looser'] ) ? $quiz_settings['title_quiz_looser'] : ''; ?>">
                </div>

                <div class="cquiz-settings-row">
                    <label for="text_quiz_looser" class="post-attributes-label"><?php esc_html_e( 'Fail description', 'codevery-quiz' ); ?></label>
                    <?php
                    $text_quiz_looser =  isset( $quiz_settings['text_quiz_looser'] ) ? $quiz_settings['text_quiz_looser'] : '';
                ...
                <h4><?php _e( 'Colors', 'codevery-quiz' ) ?></h4>
                <hr><br>

                <div class="cquiz-settings-row">
                    <label for="hover_answer_color" class="post-attributes-label"><?php esc_html_e('Option Button (on hover)', 'codevery-quiz'); ?></label>
                    <input class="color_field hover_answer_color" type="text" name="hover_answer_color" id="hover_answer_color" value="<?php echo $quiz_settings['hover_answer_color']; ?>"/>
                </div>

                <div class="cquiz-settings-row">
                    <label for="correct_answer_color" class="post-attributes-label"><?php esc_html_e('Correct Answer', 'codevery-quiz'); ?></label>
                    <input class="color_field correct_answer_color" type="text" name="correct_answer_color" id="correct_answer_color" value="<?php echo $quiz_settings['correct_answer_color']; ?>"/>
                </div>

                <div class="cquiz-settings-row">
                    <label for="incorrect_answer_color" class="post-attributes-label"><?php esc_html_e('Incorrect Answer', 'codevery-quiz'); ?></label>
                    <input class="color_field incorrect_answer_color" type="text" name="incorrect_answer_color" id="incorrect_answer_color" value="<?php echo $quiz_settings['incorrect_answer_color']; ?>"/>
                </div>
        ...
        <div id="coupon" class="tab-content">
            ...
            <style>
                ...
                .quiz-certificate .sale-percent {
                    color: <?php echo $quiz_settings['highlighted_color'] ?>;
                }
                .quiz-certificate .ribbon-bg,
                .quiz-certificate .promocode .promo {
                    background-color: <?php echo $quiz_settings['highlighted_color'] ?>;
                }
                .quiz-certificate .bow-bg svg {
                    fill: <?php echo $quiz_settings['highlighted_color'] ?>;
                }
            </style>
            <div id="coupon-options">
                <?php if ( ! is_plugin_active( 'woocommerce/woocommerce.php' ) ) : ?>
                    <div class="cquiz-error-notification">
                        <?php echo sprintf( esc_html__( 'The %s plugin must be active for the coupon functionality.', 'codevery-quiz' ), '<b>' . esc_html__( 'WooCommerce' ) . '</b>' ); ?>
                    </div>
                <?php endif; ?>
                <div class="quiz-certificate-shortcode">
                    ...
                    <code id="quiz_certificate_shortcode">[quiz_certificate quiz_id=<?php echo $post_object->ID ?>]</code><a href="#" id="copy_shortcode" class="copy_shortcode" title="Copy to Clipboard" data-copied_text_id="#quiz_certificate_shortcode" ><span class="dashicons dashicons-admin-page"></span></a>
                </div>
                <div class="cquiz-settings-row">
                    <label for="expiration_date" class="post-attributes-label"><?php esc_html_e( 'Coupon amount, %', 'codevery-quiz' ); ?></label>
                    <input type="number" id="cquiz_coupon_amount" name="coupon_amount" value="<?php echo $quiz_settings['coupon_amount'] ?>" min="0" max="99" />
                </div>
                <div class="cquiz-settings-row">
                ...
                <div class="cquiz-settings-row">
                    ...
                    <input class="color_field coupon_background_color" type="text" name="coupon_background_color" id="coupon_background_color" value="<?php echo $quiz_settings['coupon_background_color']; ?>"/>
                </div>
                <div class="cquiz-settings-row">
                    <label for="highlighted_color" class="post-attributes-label"><?php esc_html_e('Highlighted Color', 'codevery-quiz'); ?></label>
                    <input class="color_field highlighted_color" type="text" name="highlighted_color" id="highlighted_color" value="<?php echo $quiz_settings['highlighted_color']; ?>"/>
                </div>
                ...
                <div class="cquiz-settings-row">
                    ...
                    <select name="exp_date_format" id="exp_date_format">
                        <?php if ( get_locale() === 'uk_UA' ) : ?>
                            <option value="ukraine_format" <?php selected( $exp_date_format, 'ukraine_format' ) ?> ><?php echo cquiz_ua_date_format( strtotime( date( 'Y-m-d', strtotime( $expiration_date ) ) ) ); ?></option>
                        <?php endif; ?>
                        <option value="F j, Y" <?php selected( $exp_date_format, 'F j, Y' ) ?>><?php echo date( 'F j, Y', strtotime( $expiration_date ) ); ?></option>
                        <option value="d.m.Y" <?php selected( $exp_date_format, 'd.m.Y' ) ?>><?php echo date( 'd.m.Y', strtotime( $expiration_date ) ); ?></option>
                        <option value="Y-m-d" <?php selected( $exp_date_format, 'Y-m-d' ) ?>><?php echo date( 'Y-m-d', strtotime( $expiration_date ) ); ?></option>
                        <option value="m/d/Y" <?php selected( $exp_date_format, 'm/d/Y' ) ?>><?php echo date( 'm/d/Y', strtotime( $expiration_date ) ); ?></option>
                        <option value="d/m/Y" <?php selected( $exp_date_format, 'd/m/Y' ) ?>><?php echo date( 'd/m/Y', strtotime( $expiration_date ) ); ?></option>
                    </select>
                </div>
                ...
                <div class="cquiz-settings-row cquiz-settings-row-certificate">
                    <div></div>
                    <div>
                        <p class="description"><?php _e( 'You can change the titles directly on the certificate.', 'codevery-quiz' ) ?></p>
                        <div class="quiz-certificate">
                            <div class="certificate-wrap" style="background: linear-gradient(110deg, white 0%, white, 55%, <?php echo $quiz_settings['coupon_background_color']; ?> 55%, <?php echo $quiz_settings['coupon_background_color']; ?> 100%);">
                                <div class="column">
                                    ...
                                    <input type="text" class="certificate-title" name="certificate_text" value="<?php echo $quiz_settings['certificate_text'] ?>" />
                                    <div class="promocode">
                                        <input type="text" class="promocode-title" name="promocode_text" value="<?php echo $quiz_settings['promocode_text'] ?>" />
                                    ...
                                    <div class="cert-footer">
                                        ...
                                        ?>
                                        <a href="javascript:void(0);"><?php echo parse_url( site_url() )['host']; ?></a>
                                    </div>
                                </div>
                                <div class="column">
                                    <input type="text" class="certificate-sale-title" name="certificate_sale_text" value="<?php echo $quiz_settings['certificate_sale_text']; ?>" />
                                    <div class="sale-percent">
                                        <span class="sale-percent-amount"><?php echo isset( $quiz_settings['coupon_amount'] ) ? $quiz_settings['coupon_amount'] : '5'; ?></span><span class="sale-percent-symbol">%</span>
                                    </div>
                                    <div class="cert-footer">
                                        <input type="text" class="promocode-exp-text" name="promocode_exp_text" value="<?php echo $quiz_settings['promocode_exp_text']; ?>" /><br>
                                        <?php
                                        ...
                                        ?>
                                        <span class="certificate-exp-date"><?php echo $exp_date; ?></span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="cquiz-settings-row">
                    ...
                    <?php
                    $coupon_description =  isset($quiz_settings['coupon_description']) ? $quiz_settings['coupon_description'] : __( 'You can send it to your friend. The discount can be used only once in the specified period of time.', 'codevery-quiz' );
                ...
                <div class="display-email-form-fields" <?php echo $quiz_settings['display_email_form'] == 'yes' ? '' : 'style="display:none"' ?>>
                    <div>
                        <div class="cquiz-settings-row">
                            ...
                            <?php
                            $form_description =  isset( $quiz_settings['form_description'] ) ? $quiz_settings['form_description'] : esc_html__( 'We can send you this coupon by email', 'codevery-quiz' );
                    ...
                    <div>
                        <div class="cquiz-settings-row">
                            ...
                            <div>
                                ...
                                wp_editor( $email_layout, 'email_layout', array(
                                    'wpautop'       => false,
                                    'media_buttons' => false,
                                ...
                                <?php if ( $post_object->post_status != 'auto-draft' ) : ?>
                                    <div class="quiz-email-preview-button">
                                        <br>
                                        <a href="<?php echo wp_nonce_url( admin_url( '?preview_quiz_email=true&quiz_id='.$post_object->ID ), 'preview-mail' ); ?>" class="button" target="popup" onclick="window.open(this.href,'popup','width=700,height=650'); return false;"><?php _e('Preview', 'codevery-quiz'); ?></a>

<div id="quiz_settings" class="quiz-add-new-question">
    <form name="cquiz_question" action="" method="post" id="cquiz_question">
        ...
        <div class="cquiz-settings-row">
            <label for="title"><?php _e( 'Title', 'codevery-quiz' ); ?></label>
            <input type="text" id="title" name="title" required>
        </div>
        <div class="cquiz-settings-row">
            <label for="description"><?php _e( 'Description', 'codevery-quiz' ); ?></label>
            <textarea id="description" name="description"></textarea>
        </div>
        <div>
            <h3><?php _e( 'Answers', 'codevery-quiz' ) ?></h3>
            <hr>
            <br>
        </div>
        <div class="cquiz-settings-row">
            <label><?php _e( 'Type', 'codevery-quiz' ) ?></label>
            <div>
                <label class="question-type-field">
                    <input type="radio" name="question_type" value="text" checked>
                    <i class="dashicons dashicons-text" title="<?php _e( 'Text', 'codevery-quiz' ) ?>"></i>
                </label>

                <label class="question-type-field">
                    <input type="radio" name="question_type" value="image" >
                    <i class="dashicons dashicons-format-image" title="<?php _e( 'Image', 'codevery-quiz' ) ?>"></i>
                </label>
            </div>
        </div>
        ...
        <div class="quiz-repeater">
                ...
                <div class="item-hidden" data-group="answers">
                    ...
                    <div class="item-content">
                        ...
                        <div class="answer-field">
                            <label class="control-label hidden"><?php _e( 'Answer', 'codevery-quiz' ) ?></label>
                            <div class="option-type-image option-type-field">
                                ...
                                <button class="set_custom_images button"><?php _e( 'Upload Image', 'codevery-quiz' ) ?></button>
                            ...
                            <div class="option-type-text option-type-field">
                                <input type="text" class="quiz-question form-control" placeholder="<?php _e( 'Answer', 'codevery-quiz' ) ?>" data-name="option" value="">
                            </div>
                        </div>
                        <div class="answer-description">
                            <label class="control-label hidden"><?php _e( 'Description', 'codevery-quiz' ) ?></label>
                            <div>
                                <textarea class="form-control" data-name="description" placeholder="<?php _e( 'Describe why this option is correct or incorrect', 'codevery-quiz' ) ?>"></textarea>
                            </div>
                        </div>

                        <div class="correct-answer">
                            <label class="control-label"><input type="radio" class="form-control" data-name="answer" data-skip-name="1" required>
                                <?php _e( 'Correct answer', 'codevery-quiz' ) ?></label>
                        </div>

                        <!-- Repeater Remove Btn -->
                        <a href="#" type="button" class="btn-danger remove-item">
                            <span class="dashicons dashicons-trash"></span><span class="hidden"><?php _e( 'Remove', 'codevery-quiz' ) ?></span>
                        </a>
                    </div>
            ...
            <button type="button" class="cquiz-button cquiz-add-item">
                <?php _e( 'Add Answer', 'codevery-quiz' ) ?>
            </button>
        </div>
        <div class="cquiz-action-buttons">
            <span class="spinner"></span>
            <button type="submit" class="button button-primary cquiz-button cquiz-save-item" data-field_id="<?php echo sanitize_text_field($_REQUEST['field_id']) ?>">
                <?php _e( 'Save', 'codevery-quiz' ) ?>
            </button>
        </div>
    </form>
</div>
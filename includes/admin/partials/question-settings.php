                    ...
                    <div class="item" >
                        <div class="item-content">
                            ...
                            <div class="answer-field">
                                ...
                                <div class="option-type-image option-type-field <?php echo $question_type == 'image' ? 'active-type' : '' ?>" >
                                    <div class="option-preview-image"><?php echo $image ? '<img src="'.$image[0].'">' : '' ?></div>
                                    <input type="hidden" class="process_custom_images" name="answers[<?php echo $key ?>][image_id]" value="<?php echo $options['image_id']; ?>">
                                ...
                                <div class="option-type-text option-type-field <?php echo $question_type == 'image' ? 'active-type' : '' ?>" >
                                    <input type="text" class="quiz-question form-control" placeholder="<?php esc_html_e( 'Answer', 'codevery-quiz' ); ?>" name="answers[<?php echo $key ?>][option]" value="<?php echo $options['option']; ?>">
                                </div>
                            </div>
                            <div class="answer-description">
                                <label class="control-label hidden"><?php esc_html_e( 'Description', 'codevery-quiz' ); ?></label>
                                <div>
                                    <textarea class="form-control" name="answers[<?php echo $key ?>][description]" placeholder="<?php esc_html_e( 'Describe why this option is correct or incorrect', 'codevery-quiz' ); ?>"><?php echo $options['description']; ?></textarea>
                                </div>
                            </div>

                            <div class="correct-answer">
                                <label class="control-label"><input type="radio" class="form-control" value="<?php echo $key ?>" name="answer" data-skip-name="1" required <?php echo isset($options['answer']) && $options['answer'] ? 'checked' : '' ?>>
                                    <?php esc_html_e( 'Correct answer', 'codevery-quiz' ); ?></label>
                            </div>

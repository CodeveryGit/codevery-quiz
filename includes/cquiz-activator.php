    ...
    public static function activate() {
        ...
        if ( $quiz_questions ) {
            foreach ( $quiz_questions as $key => $question ) {
                ...
                $question_options = json_encode( $question_options, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES );
        ...
        update_post_meta( $demo_quiz_id, 'quiz_questions', json_encode( $quiz_question_points, JSON_UNESCAPED_UNICODE ) );
        ...
        update_post_meta( $demo_quiz_id, 'quiz_settings', json_encode( $quiz_settings, JSON_UNESCAPED_UNICODE ) );
